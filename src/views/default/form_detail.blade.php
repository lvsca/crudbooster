...
?>
	@if(file_exists(base_path('/vendor/whytobe/crudbooster/src/views/default/type_components/'.$type.'/asset.blade.php')))
...
foreach($forms as $index=>$form):
	...
	$file_location = base_path('vendor/whytobe/crudbooster/src/views/default/type_components/'.$type.'/component_detail.blade.php');
